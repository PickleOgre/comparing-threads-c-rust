...
# Prep for Experiment
---
- (DONE) Trim down both the C and Rust implementations for DNS resolution, and make sure they are as idiomatic and efficient as reasonably possible
- Prepare a C and Rust implementation for the other test cases, i.e. Matrix Multiplication and Monte Carlo
